...
<f:view>		  
    <h:form>
        ...
        <h:panelGrid border="0" columns="3">        
            ...
            <h:inputText id="User_ID" value="#{user.id}" required="true" requiredMessage="Id is required">            	            	
        ...
        <h:commandButton id="submitButton" action="#{user.addUser}" value="Add Customer" ></h:commandButton>                      
    </h:form>
</f:view>
</body>
</html>
